...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpt-model', type=str, default='gpt-4-1106-preview') # gpt-4-0314 gpt-4-turbo-2024-04-09
    ...
    print("use gpt-model: ", args.gpt_model)
    ...
    for i, response in enumerate(responses):
        ...
        if len(scores_found) == 1:
            ...
            if len(scores_found) == 0:
                print('Warning: zero scores found')
            else:
                print('Warning: multiple scores found')
            print(i, response)
            scores.append(0)
